...
export declare class SalesService {
    ...
    logger: Logger;
    constructor(saleRepository: Repository<Sale>, eventService: EventService, userService: UserService, ticketService: TicketsService, localitiesService: LocalitiesService, firebaseService: FirebaseService, encryptionService: EncryptionService, logPayCardService: LogPayCardService, mailService: MailService, logSaleService: LogSaleService);
