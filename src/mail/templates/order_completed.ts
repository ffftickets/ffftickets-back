...
export const OrderComplete = (data: OrderCompletedDto) => {
  ...
  if (pay.number!==null) {
    transaccionCode=`  <tr>
    <td><b>Código de transacción</b></td>
    <td>${pay.number}</td>
    </tr>`
  }
  let contenidoHTML = '';
...
<table id="u_content_text_9" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 35px; font-weight: 700; color: #000000; line-height: 120%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 120%;"><span style="color: #843fa1; line-height: 42px;">Pedido Completado</span></p>
  </div>
...
<table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 140%;"><span style="color: #000000; line-height: 19.6px;">Gracias por tu pedido. Tu pedido reciente en FFFTickets se ha completado exitosamente. Los detalles se muestran a continuación:</span></p>
  </div>
...
<table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 18px; line-height: 50%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 50%;"><strong>Datos de Transacción:</strong></p>
...
<table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 18px; line-height: 50%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 50%;"><strong>Facturación:</strong></p>
<p style="line-height: 50%;"> </p>
  </div>
...
<table id="u_content_text_15" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 140%;"><span style="color: #000000; line-height: 19.6px;">Tus entradas han sido enviadas en otro correo, tambien puedes acceder mediante  tu cuenta de FFFTickets ingresando a <a rel="noopener" href="https://ffftickets.com/" target="_blank"><strong><span style="color: #843fa1; line-height: 19.6px;">MIS Compras.</span></strong></a></span></p>
  </div>
